...
public class AndroidResourceAnnotatedTypeFactory extends BaseAnnotatedTypeFactory {
  ...
  protected final AnnotationMirror ANIM_RES = AnnotationBuilder.fromClass(elements, AnimRes.class);
  ...
  protected final AnnotationMirror ATTR_RES = AnnotationBuilder.fromClass(elements, AttrRes.class);
  /** The @BoolRes annotation. */
  protected final AnnotationMirror BOOL_RES = AnnotationBuilder.fromClass(elements, BoolRes.class);
  ...
  protected final AnnotationMirror FONT_RES = AnnotationBuilder.fromClass(elements, FontRes.class);
  ...
  protected final AnnotationMirror MENU_RES = AnnotationBuilder.fromClass(elements, MenuRes.class);
        ...
        (packagePrefix) ->
            ANNOTATION_MIRROR_MAP.forEach(
                (annotationName, annotation) ->
                    addAliasedAnnotation(packagePrefix + annotationName, annotation)));
  }
  ...
  private class AndroidResourceTreeAnnotator extends TreeAnnotator {
    ...
    public Void visitMemberSelect(MemberSelectTree node, AnnotatedTypeMirror annotatedTypeMirror) {
      ...
      //                    + node.getIdentifier() + ", ATM: " + annotatedTypeMirror.toString()
      //                    + "\n");
